...
class StorageHandlerModule:
    ...
    GCP: str = "express_components.helpers.storage.gcp_storage"
    AWS: str = "express_components.helpers.storage.aws_storage"
    AZURE: str = "express_components.helpers.storage.azure_storage"
