...
def parse_kfp_list(kfp_parsed_string: str) -> list:
    """
    This is mainly to resolve issues in passing a list to kfp components passed as
    'JsonArray`. kfp will return a json string object instead of a list. This function parses
     the json string to return the original list
