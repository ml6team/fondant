"""Stable diffusion finetuning. Cloned from commit: f7154f859ce4534227962ccd190eaf428ef0abc8
Cloning from a commit since the finetuning script contains updates not included in the latest
# diffusers release (04/01/2023)"""
# pylint: skip-file
import argparse
import copy
import logging
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=None,
        required=True,
        help="Path to pretrained model or Model identifier from huggingface.co/models or gcs path to a model.",
    )
    parser.add_argument(
        "--revision",
        type=str,
