...
add_captions_op = comp.load_component(
    '/Users/nielsrogge/Documents/python_projects/express/examples/pipelines/hf_dataset_pipeline/components/add_captions/component.yaml')
