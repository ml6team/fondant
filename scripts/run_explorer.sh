#!/bin/bash
# TODO: define whether we need a separate bash script for this. cli.py can do this as well in python,
# together with the poetry command `data_explorer` that is defined in pyproject.toml.
